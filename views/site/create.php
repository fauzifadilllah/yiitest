...
<h1 style="color : #337ab7;">Create Pasien</h1>
    ...
    <div class="body-content">
        ...
        <div class="row">
            <div class="form-group">
                <div class="col-lg-6">
                <?php $items = ['Sudah Poli'=>'Sudah Poli','Belum Poli'=>'Belum Poli']?>
                    <?=$form->field($post,'keterangan')->dropDownList($items)?>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="form-group">
                ...
                <?php $items = [date('Y-m-d')=>'date']?>
                    <?=$form->field($post,'tgl')->dropDownList($items)->label(false)?>
                </div>
            </div>
        </div>
